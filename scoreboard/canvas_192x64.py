...
class Canvas:
    ...
    def draw_match(self, matrix, match):
        ...
        graphics.DrawCircle(self.canvas, 183, 26, 2, self.divide_line_color)
        graphics.DrawCircle(self.canvas, 173, 26, 2, self.divide_line_color)

        graphics.DrawCircle(self.canvas, 183, 58, 2, self.divide_line_color)
        graphics.DrawCircle(self.canvas, 173, 58, 2, self.divide_line_color)

        if match.team1_sets() > 0:
            graphics.DrawCircle(self.canvas, 173, 26, 2, self.server_color)
            graphics.DrawCircle(self.canvas, 173, 26, 1, self.server_color)
            graphics.DrawCircle(self.canvas, 173, 26, 0, self.server_color)

        if match.team1_sets() > 1:
            graphics.DrawCircle(self.canvas, 183, 26, 2, self.server_color)
            graphics.DrawCircle(self.canvas, 183, 26, 1, self.server_color)
            graphics.DrawCircle(self.canvas, 183, 26, 0, self.server_color)

        if match.team2_sets() > 0:
            graphics.DrawCircle(self.canvas, 173, 58, 2, self.server_color)
            graphics.DrawCircle(self.canvas, 173, 58, 1, self.server_color)
            graphics.DrawCircle(self.canvas, 173, 58, 0, self.server_color)

        if match.team2_sets() > 1:
            graphics.DrawCircle(self.canvas, 183, 58, 2, self.server_color)
            graphics.DrawCircle(self.canvas, 183, 58, 1, self.server_color)
            graphics.DrawCircle(self.canvas, 183, 58, 0, self.server_color)
